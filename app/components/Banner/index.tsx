...
const Banner = () => {
    ...
    return (
        <div className='bg-image relative' id="home-section">
            ...
            <ModalVideo channel='youtube' isOpen={isOpen} youtube={{ autoplay: 1, mute: 1 }} videoId="dQw4w9WgXcQ" onClose={() => setOpen(false)} />
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-12 my-16'>
                        ...
                        <div className='col-span-7'>
                            ...
                            <div className='flex align-middle justify-center md:justify-start'>
                                <Link href="/signin" className='text-xl font-semibold text-white py-4 px-6 lg:px-12 navbutton mr-6'>
                                    Get Started
                                </Link>
